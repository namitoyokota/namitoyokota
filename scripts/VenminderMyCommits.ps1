$user = "namito.yokota@venminder.com"
$token = "oxv5bpfrik4csutqjkgofuinxrof564wjq4bvxsymik735qxgqkq"
...
$commitTable.GetEnumerator() | Sort-Object { $_."Name" -as [datetime] } | Select-Object -Property @{N='Date';E={$_.Key}}, @{N='Count';E={$_.Value}} | Export-Csv -NoTypeInformation -Path "../outputs/Commits-$(get-date -f yyyy-MM-dd).csv"
