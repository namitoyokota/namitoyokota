...
JNIEXPORT jstring JNICALL Java_edu_cs300_MessageJNI_readStringMsg(JNIEnv *env, jobject obj)
{
 ...
 */
JNIEXPORT void JNICALL Java_edu_cs300_MessageJNI_writeLongestWordResponseMsg(JNIEnv *env, jobject obj, jint prefixID, jstring prefixStr, jint passageIndex, jstring passageNameStr, jstring longestWordStr, jint passageCount, jint present)
{
